...
4.)Outline of work done
Team participants: Paige Romero and Hans Weeks
Paige- wrote the Graphical output of the program, did the most significant modification of the file initially titled
	ClientRandomWalk (now ClientControl), thus creating logic of choosing AntActions
Hans- created the action queues for  the ants, the populating of those queues, the straightline and best path travel, 
and the NodeMap/NodeData portions
Both - the most significant portion of time on this project was spent debugging creating more complex action/reactions for the
ants.
